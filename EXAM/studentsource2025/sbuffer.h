...
#include "config.h"
// Identifiers for the readers
#define READER_DATAMGR 0
#define READER_STOREMGR 1
...
typedef struct sbuffer_node {
 ...
 int readers_left;           /** Count of how many readers still need this node*/
} sbuffer_node_t;
...
typedef struct sbuffer {
 ...
 pthread_mutex_t mtx;
 pthread_cond_t cond;
 int head_read_by_data;
 int head_read_by_store;
}sbuffer_t;
